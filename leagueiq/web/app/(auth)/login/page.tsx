  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <h1 className="text-4xl font-extrabold text-center tracking-tight mb-1">LeagueIQ</h1>
        <p className="text-gray-400 text-center text-sm mb-10">Football Trivia. Your Leagues.</p>
